...
const electionDay = "Oct 2 2022 08:00:00 GMT-0300";
const lastDayOfHim = "Dec 31 2022 23:59:59 GMT-0300";
const useAlternateDate = window.location.href.search("year");

const getEndDate = () => {
  return new Date(useAlternateDate >= 0 ? lastDayOfHim : electionDay);
};
